...
查看Math::floor的代码发现其实就是个类型转换，直接舍弃浮点位数，然后在舍弃后原值小于目标值（也就是负数）的情况下对目标值-1保证负数符合预期：
<img width="319" height="86" alt="image" src="https://github.com/user-attachments/assets/c1771132-4a3d-41b9-9570-7f8b4730e4a8" />

我们目前的值是个正数，所以直接不变，相当于box.minX - 2.0或者box.maxX + 2.0之后只要任意满足一个能得到我们的值，就至少可以触发bug，于是：
box.minX = 33,554,416.0 + 2.0 = 33,554,418.0，或者box.maxX = 33,554,416.0 - 2.0 = 33,554,416.0之间会触发，
